(function (root, factory) {
  ...
  var toULongOrNull = kotlin_kotlin.$_$.o9;
  ...
  var isLetter = kotlin_kotlin.$_$.a9;
  var charSequenceLength = kotlin_kotlin.$_$.i7;
  var last = kotlin_kotlin.$_$.d9;
  var toString_0 = kotlin_kotlin.$_$.u1;
  var isUpperCase = kotlin_kotlin.$_$.c9;
  var toLong_0 = kotlin_kotlin.$_$.k8;
  var _UInt___init__impl__l7qpdl = kotlin_kotlin.$_$.i2;
  var UInt__toString_impl_dbgl21 = kotlin_kotlin.$_$.k2;
  var _ULong___init__impl__c78o9k = kotlin_kotlin.$_$.r2;
  var ULong__toString_impl_f9au7k = kotlin_kotlin.$_$.t2;
  ...
  var coerceAtLeast = kotlin_kotlin.$_$.n8;
  ...
  var singleOrNull = kotlin_kotlin.$_$.b6;
  var arrayIterator = kotlin_kotlin.$_$.d7;
  var emptyMap = kotlin_kotlin.$_$.k5;
  var getValue = kotlin_kotlin.$_$.m5;
  var fillArrayVal = kotlin_kotlin.$_$.m7;
  var toString_1 = kotlin_kotlin.$_$.db;
  ...
  var DeepRecursiveFunction = kotlin_kotlin.$_$.v9;
  var invoke = kotlin_kotlin.$_$.va;
  var CoroutineImpl = kotlin_kotlin.$_$.b7;
  var DeepRecursiveScope = kotlin_kotlin.$_$.w9;
  var Unit = kotlin_kotlin.$_$.pa;
  ...
  var IllegalArgumentException = kotlin_kotlin.$_$.z9;
  var isFinite = kotlin_kotlin.$_$.xa;
  var isFinite_0 = kotlin_kotlin.$_$.wa;
  var decodeNullableSerializableValue = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.p1;
  var decodeSequentially = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.l1;
  var decodeCollectionSize = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.k1;
  var decodeNullableSerializableElement$default = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.b;
  var toUInt = kotlin_kotlin.$_$.n9;
  var _UInt___get_data__impl__f0vqqw = kotlin_kotlin.$_$.j2;
  var toULong = kotlin_kotlin.$_$.p9;
  var toUByte = kotlin_kotlin.$_$.m9;
  var _UByte___get_data__impl__jof9qr = kotlin_kotlin.$_$.a2;
  var toUShort = kotlin_kotlin.$_$.q9;
  ...
  var numberToChar = kotlin_kotlin.$_$.g8;
  var equals_0 = kotlin_kotlin.$_$.y8;
  var toByte = kotlin_kotlin.$_$.j8;
  ...
  var toShort = kotlin_kotlin.$_$.l8;
  var single = kotlin_kotlin.$_$.e9;
  var emptySet = kotlin_kotlin.$_$.l5;
  var plus_0 = kotlin_kotlin.$_$.y5;
  var toList = kotlin_kotlin.$_$.f6;
  var throwUninitializedPropertyAccessException = kotlin_kotlin.$_$.cb;
  var encodeSerializableValue = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.v1;
  var shouldEncodeElementDefault = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.n1;
  ...
  var last_0 = kotlin_kotlin.$_$.t5;
  var removeLast = kotlin_kotlin.$_$.z5;
  ...
  setMetadataFor(JsonClassDiscriminator, 'JsonClassDiscriminator', classMeta, undefined, [Annotation], undefined, undefined, []);
  setMetadataFor(JsonNames, 'JsonNames', classMeta, undefined, [Annotation], undefined, undefined, []);
  ...
  setMetadataFor(JsonNamingStrategy, 'JsonNamingStrategy', interfaceMeta, undefined, undefined, undefined, undefined, []);
  setMetadataFor(JsonNamingStrategy$Builtins$SnakeCase$1, undefined, classMeta, undefined, [JsonNamingStrategy], undefined, undefined, []);
  setMetadataFor(Builtins, 'Builtins', objectMeta, undefined, undefined, undefined, undefined, []);
  ...
  setMetadataFor(JsonWriter, 'JsonWriter', interfaceMeta, undefined, undefined, undefined, undefined, []);
  setMetadataFor(JsonTreeReader$readDeepRecursive$slambda, 'JsonTreeReader$readDeepRecursive$slambda', classMeta, CoroutineImpl, [CoroutineImpl], undefined, undefined, [2]);
  ...
  setMetadataFor(SuppressAnimalSniffer, 'SuppressAnimalSniffer', classMeta, undefined, [Annotation], undefined, undefined, []);
  ...
  setMetadataFor(AbstractJsonTreeEncoder, 'AbstractJsonTreeEncoder', classMeta, NamedValueEncoder, [NamedValueEncoder, JsonEncoder], undefined, undefined, []);
  setMetadataFor(JsonTreeEncoder, 'JsonTreeEncoder', classMeta, AbstractJsonTreeEncoder, undefined, undefined, undefined, []);
  setMetadataFor(AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1, undefined, classMeta, AbstractEncoder, undefined, undefined, undefined, []);
  setMetadataFor(AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$1, undefined, classMeta, AbstractEncoder, undefined, undefined, undefined, []);
  setMetadataFor(JsonPrimitiveEncoder, 'JsonPrimitiveEncoder', classMeta, AbstractJsonTreeEncoder, undefined, undefined, undefined, []);
  setMetadataFor(JsonTreeListEncoder, 'JsonTreeListEncoder', classMeta, AbstractJsonTreeEncoder, undefined, undefined, undefined, []);
  setMetadataFor(JsonTreeMapEncoder, 'JsonTreeMapEncoder', classMeta, JsonTreeEncoder, undefined, undefined, undefined, []);
  ...
  setMetadataFor(JsonToStringWriter, 'JsonToStringWriter', classMeta, undefined, [JsonWriter], undefined, undefined, []);
  //endregion
  function Default() {
    Default_instance = this;
    Json.call(this, JsonConfiguration_init_$Create$(false, false, false, false, false, false, null, false, false, null, false, false, null, 8191, null), EmptySerializersModule());
  }
  ...
  Json.prototype.encodeToString_bhi5ce_k$ = function (serializer, value) {
  ...
  Json.prototype.decodeFromString_d9fce8_k$ = function (deserializer, string) {
  ...
  Json.prototype.encodeToJsonElement_lfuu27_k$ = function (serializer, value) {
    return writeJson(this, value, serializer);
  };
  Json.prototype.decodeFromJsonElement_b9lc7m_k$ = function (deserializer, element) {
  ...
  JsonBuilder.prototype.set_namingStrategy_g18rup_k$ = function (_set____db54di) {
    this.namingStrategy_1 = _set____db54di;
  };
  JsonBuilder.prototype.get_namingStrategy_kue0is_k$ = function () {
  ...
  JsonConfiguration.prototype.get_namingStrategy_kue0is_k$ = function () {
    return this.namingStrategy_1;
  };
  ...
  JsonLiteral.prototype.get_coerceToInlineType_vv6udq_k$ = function () {
  ...
  function JsonPrimitive_1(value) {
    ...
    if (value == null)
      return JsonNull_getInstance();
    return JsonLiteral_init_$Create$(value, false, null, 4, null);
  }
  ...
  JsonNamingStrategy$Builtins$SnakeCase$1.prototype.serialNameForJson_hcdeen_k$ = function (descriptor, elementIndex, serialName) {
    var tmp$ret$7;
    // Inline function 'kotlin.text.buildString' call
  ...
  JsonNamingStrategy$Builtins$SnakeCase$1.prototype.toString = function () {
  ...
  Builtins.prototype.get_SnakeCase_rzhe7t_k$ = function () {
  ...
  ComposerForUnquotedLiterals.prototype.printQuoted_vsh1i5_k$ = function (value) {
    if (this.forceQuoting_1) {
      Composer.prototype.printQuoted_vsh1i5_k$.call(this, value);
    } else {
      Composer.prototype.print_mp71d1_k$.call(this, value);
    }
  };
  ...
  PolymorphismValidator.prototype.contextual_oi2m58_k$ = function (kClass, provider) {
  };
  PolymorphismValidator.prototype.polymorphic_sbh4xj_k$ = function (baseClass, actualClass, actualSerializer) {
  ...
  PolymorphismValidator.prototype.polymorphicDefaultSerializer_g5ty2r_k$ = function (baseClass, defaultSerializerProvider) {
  };
  PolymorphismValidator.prototype.polymorphicDefaultDeserializer_vtblm7_k$ = function (baseClass, defaultDeserializerProvider) {
  };
  ...
  DescriptorSchemaCache.prototype.set_rrqmqe_k$ = function (descriptor, key, value) {
    // Inline function 'kotlin.collections.set' call
    var tmp$ret$1;
  ...
  DescriptorSchemaCache.prototype.getOrPut_nie706_k$ = function (descriptor, key, defaultValue) {
  ...
  DescriptorSchemaCache.prototype.get_kuyzdy_k$ = function (descriptor, key) {
  ...
  function coerceInputValue($this, descriptor, index) {
    ...
    $l$block_1: {
      ...
      if (equals(tmp1_tryCoerceValue.get_kind_wop7ml_k$(), ENUM_getInstance())) {
        var tmp$ret$2;
        // Inline function 'kotlinx.serialization.json.internal.StreamingJsonDecoder.coerceInputValue.<anonymous>' call
        tmp$ret$2 = $this.lexer_1.peekString_9klnyq_k$($this.configuration_1.get_isLenient_1g1x8_k$());
  ...
  StreamingJsonDecoder.prototype.decodeSerializableValue_6v83lo_k$ = function (deserializer) {
    try {
      var tmp;
      if (!(deserializer instanceof AbstractPolymorphicSerializer)) {
        tmp = true;
      ...
      if ($p instanceof MissingFieldException) {
        throw new MissingFieldException($p.get_missingFields_wryzxm_k$(), plus($p.message, ' at path: ') + this.lexer_1.get_path_wos8ry_k$().getPath_18su3p_k$(), $p);
      } else {
        throw $p;
      }
    }
  ...
  StreamingJsonDecoder.prototype.decodeSerializableElement_nrfur_k$ = function (descriptor, index, deserializer, previousValue) {
    ...
    var value = AbstractDecoder.prototype.decodeSerializableElement_nrfur_k$.call(this, descriptor, index, deserializer, previousValue);
    if (isMapKey) {
  ...
  StreamingJsonEncoder.prototype.encodeSerializableValue_g55msp_k$ = function (serializer, value) {
    var tmp$ret$0;
    $l$block: {
  ...
  StreamingJsonEncoder.prototype.encodeNullableSerializableElement_j50jzb_k$ = function (descriptor, index, serializer, value) {
    if (!(value == null) ? true : this.configuration_1.get_explicitNulls_ppiuof_k$()) {
      AbstractEncoder.prototype.encodeNullableSerializableElement_j50jzb_k$.call(this, descriptor, index, serializer, value);
    }
  };
  StreamingJsonEncoder.prototype.encodeInline_8gn4q6_k$ = function (descriptor) {
    ...
    if (get_isUnsignedNumber(descriptor)) {
      ...
      tmp = AbstractEncoder.prototype.encodeInline_8gn4q6_k$.call(this, descriptor);
    }
    return tmp;
  };
  ...
  StreamingJsonEncoder.prototype.encodeFloat_f5fde1_k$ = function (value) {
    ...
    if (!this.configuration_1.get_allowSpecialFloatingPointValues_1eu5hp_k$() ? !isFinite(value) : false) {
      throw InvalidFloatingPointEncoded(value, toString(this.composer_1.get_writer_lin69o_k$()));
    }
  };
  ...
  AbstractJsonTreeDecoder.prototype.decodeSerializableValue_6v83lo_k$ = function (deserializer) {
  ...
  JsonTreeDecoder.prototype.elementName_9sehmv_k$ = function (descriptor, index) {
  ...
  JsonTreeListDecoder.prototype.elementName_9sehmv_k$ = function (descriptor, index) {
  ...
  JsonTreeMapDecoder.prototype.elementName_9sehmv_k$ = function (descriptor, index) {
    var i = index / 2 | 0;
  ...
  JsonTreeEncoder.prototype.encodeNullableSerializableElement_j50jzb_k$ = function (descriptor, index, serializer, value) {
    if (!(value == null) ? true : this.configuration_1.get_explicitNulls_ppiuof_k$()) {
      AbstractJsonTreeEncoder.prototype.encodeNullableSerializableElement_j50jzb_k$.call(this, descriptor, index, serializer, value);
    }
  };
  ...
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.get_serializersModule_piitvg_k$ = function () {
    return this.serializersModule_1;
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.putUnquotedString_bv71rl_k$ = function (s) {
    return this.this$0__1.putElement_q1lsnv_k$(this.$tag_1, JsonLiteral_init_$Create$(s, false, null, 4, null));
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.encodeInt_5vxmon_k$ = function (value) {
    var tmp$ret$0;
    // Inline function 'kotlin.toUInt' call
    tmp$ret$0 = _UInt___init__impl__l7qpdl(value);
    return this.putUnquotedString_bv71rl_k$(UInt__toString_impl_dbgl21(tmp$ret$0));
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.encodeLong_rk3ab9_k$ = function (value) {
    var tmp$ret$0;
    // Inline function 'kotlin.toULong' call
    tmp$ret$0 = _ULong___init__impl__c78o9k(value);
    return this.putUnquotedString_bv71rl_k$(ULong__toString_impl_f9au7k(tmp$ret$0));
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.encodeByte_gpyndp_k$ = function (value) {
    var tmp$ret$0;
    // Inline function 'kotlin.toUByte' call
    tmp$ret$0 = _UByte___init__impl__g9hnc4(value);
    return this.putUnquotedString_bv71rl_k$(UByte__toString_impl_v72jg(tmp$ret$0));
  };
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.encodeShort_rh3vxz_k$ = function (value) {
    var tmp$ret$0;
    // Inline function 'kotlin.toUShort' call
  ...
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$1.prototype.get_serializersModule_piitvg_k$ = function () {
    return this.this$0__1.json_1.get_serializersModule_piitvg_k$();
  };
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$1.prototype.encodeString_90sumj_k$ = function (value) {
  ...
  AbstractJsonTreeEncoder.prototype.elementName_9sehmv_k$ = function (descriptor, index) {
  ...
  AbstractJsonTreeEncoder.prototype.encodeSerializableValue_g55msp_k$ = function (serializer, value) {
  ...
  AbstractJsonTreeEncoder.prototype.encodeTaggedChar_q2imt2_k$ = function (tag, value) {
    return this.putElement_q1lsnv_k$(tag, JsonPrimitive_0(toString_0(value)));
  };
  ...
  AbstractJsonTreeEncoder.prototype.encodeTaggedInline_n78nx5_k$ = function (tag, inlineDescriptor) {
    return get_isUnsignedNumber(inlineDescriptor) ? inlineUnsignedNumberEncoder(this, tag) : get_isUnquotedLiteral(inlineDescriptor) ? inlineUnquotedLiteralEncoder(this, tag, inlineDescriptor) : NamedValueEncoder.prototype.encodeTaggedInline_nljf4l_k$.call(this, tag, inlineDescriptor);
  };
  ...
  PolymorphismValidator.prototype.contextual_ki5uma_k$ = contextual;
  PolymorphismValidator.prototype.polymorphicDefault_zfjs7w_k$ = polymorphicDefault;
  StreamingJsonDecoder.prototype.decodeSerializableElement$default_t023k4_k$ = decodeSerializableElement$default;
  StreamingJsonDecoder.prototype.decodeNullableSerializableValue_f10m3r_k$ = decodeNullableSerializableValue;
  ...
  StreamingJsonDecoder.prototype.decodeNullableSerializableElement$default_x1t78n_k$ = decodeNullableSerializableElement$default;
  JsonDecoderForUnsignedTypes.prototype.decodeSerializableValue_6v83lo_k$ = decodeSerializableValue;
  JsonDecoderForUnsignedTypes.prototype.decodeSerializableElement$default_t023k4_k$ = decodeSerializableElement$default;
  JsonDecoderForUnsignedTypes.prototype.decodeNullableSerializableElement$default_x1t78n_k$ = decodeNullableSerializableElement$default;
  JsonDecoderForUnsignedTypes.prototype.decodeNullableSerializableValue_f10m3r_k$ = decodeNullableSerializableValue;
  ...
  StreamingJsonEncoder.prototype.encodeNullableSerializableValue_4n8qik_k$ = encodeNullableSerializableValue;
  AbstractJsonTreeDecoder.prototype.decodeSerializableElement$default_t023k4_k$ = decodeSerializableElement$default;
  AbstractJsonTreeDecoder.prototype.decodeNullableSerializableElement$default_x1t78n_k$ = decodeNullableSerializableElement$default;
  AbstractJsonTreeDecoder.prototype.decodeNullableSerializableValue_f10m3r_k$ = decodeNullableSerializableValue;
  ...
  JsonTreeDecoder.prototype.decodeSerializableElement$default_t023k4_k$ = decodeSerializableElement$default;
  JsonTreeDecoder.prototype.decodeNullableSerializableElement$default_x1t78n_k$ = decodeNullableSerializableElement$default;
  JsonTreeDecoder.prototype.decodeNullableSerializableValue_f10m3r_k$ = decodeNullableSerializableValue;
  ...
  JsonTreeListDecoder.prototype.decodeSerializableElement$default_t023k4_k$ = decodeSerializableElement$default;
  JsonTreeListDecoder.prototype.decodeNullableSerializableElement$default_x1t78n_k$ = decodeNullableSerializableElement$default;
  JsonTreeListDecoder.prototype.decodeNullableSerializableValue_f10m3r_k$ = decodeNullableSerializableValue;
  ...
  JsonPrimitiveDecoder.prototype.decodeSerializableElement$default_t023k4_k$ = decodeSerializableElement$default;
  JsonPrimitiveDecoder.prototype.decodeNullableSerializableElement$default_x1t78n_k$ = decodeNullableSerializableElement$default;
  JsonPrimitiveDecoder.prototype.decodeNullableSerializableValue_f10m3r_k$ = decodeNullableSerializableValue;
  ...
  JsonTreeMapDecoder.prototype.decodeSerializableElement$default_t023k4_k$ = decodeSerializableElement$default;
  JsonTreeMapDecoder.prototype.decodeNullableSerializableElement$default_x1t78n_k$ = decodeNullableSerializableElement$default;
  JsonTreeMapDecoder.prototype.decodeNullableSerializableValue_f10m3r_k$ = decodeNullableSerializableValue;
  ...
  AbstractJsonTreeEncoder.prototype.encodeNullableSerializableValue_4n8qik_k$ = encodeNullableSerializableValue;
  JsonTreeEncoder.prototype.beginCollection_dgpn47_k$ = beginCollection;
  JsonTreeEncoder.prototype.encodeNullableSerializableValue_4n8qik_k$ = encodeNullableSerializableValue;
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.encodeNotNullMark_40lhgg_k$ = encodeNotNullMark;
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.beginCollection_dgpn47_k$ = beginCollection;
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.encodeSerializableValue_g55msp_k$ = encodeSerializableValue;
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.encodeNullableSerializableValue_4n8qik_k$ = encodeNullableSerializableValue;
  AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1.prototype.shouldEncodeElementDefault_m92hrm_k$ = shouldEncodeElementDefault;
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$1.prototype.encodeNotNullMark_40lhgg_k$ = encodeNotNullMark;
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$1.prototype.beginCollection_dgpn47_k$ = beginCollection;
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$1.prototype.encodeSerializableValue_g55msp_k$ = encodeSerializableValue;
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$1.prototype.encodeNullableSerializableValue_4n8qik_k$ = encodeNullableSerializableValue;
  AbstractJsonTreeEncoder$inlineUnquotedLiteralEncoder$1.prototype.shouldEncodeElementDefault_m92hrm_k$ = shouldEncodeElementDefault;
  JsonPrimitiveEncoder.prototype.beginCollection_dgpn47_k$ = beginCollection;
  JsonPrimitiveEncoder.prototype.encodeNullableSerializableValue_4n8qik_k$ = encodeNullableSerializableValue;
  JsonTreeListEncoder.prototype.beginCollection_dgpn47_k$ = beginCollection;
  JsonTreeListEncoder.prototype.encodeNullableSerializableValue_4n8qik_k$ = encodeNullableSerializableValue;
  JsonTreeMapEncoder.prototype.beginCollection_dgpn47_k$ = beginCollection;
  JsonTreeMapEncoder.prototype.encodeNullableSerializableValue_4n8qik_k$ = encodeNullableSerializableValue;
  //endregion
  //region block: init
